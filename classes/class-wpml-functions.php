...
{	
	...
	public function wpml_register_dynamic_string() {
		...
		$people_email_inquiry_global_settings = array_map( array( $people_contact_admin_interface, 'admin_stripslashes' ), get_option( 'people_email_inquiry_global_settings', array() ) );
		...
		if ( function_exists('icl_register_string') ) {
			...
			$people_contact_global_settings = array_map( array( $people_contact_admin_interface, 'admin_stripslashes' ), get_option( 'people_contact_global_settings', array() ) );
			...
			$people_contact_widget_information = array_map( array( $people_contact_admin_interface, 'admin_stripslashes' ), get_option( 'people_contact_widget_information', array() ) );
			...
			$people_contact_widget_email_contact_form = array_map( array( $people_contact_admin_interface, 'admin_stripslashes' ), get_option( 'people_contact_widget_email_contact_form', array() ) );
			...
			$people_contact_widget_maps = array_map( array( $people_contact_admin_interface, 'admin_stripslashes' ), get_option( 'people_contact_widget_maps', array() ) );
			...
			icl_register_string($this->plugin_wpml_name, 'Profile Cards - Email Link Text', __( 'Click Here', 'cup_cp' ) );
			icl_register_string($this->plugin_wpml_name, 'Profile Cards - Website Link Text', __( 'Visit Website', 'cup_cp' ) );
		}
	}

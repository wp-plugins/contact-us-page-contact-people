...
<?php
/*-----------------------------------------------------------------------------------
People Email Inquiry Fancybox Popup Settings
...
class People_Email_Inquiry_Fancybox_Popup_Settings extends People_Contact_Admin_UI
{
	 ...
	 */
	public $option_name = 'people_email_inquiry_fancybox_popup_settings';
	
	/**
	 * @var string
	 * You must change to correct form key that you are working
	 */
	public $form_key = 'people_email_inquiry_fancybox_popup_settings';
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Fancybox Pop-Up Settings successfully saved.', 'cup_cp' ),
				'error_message'		=> __( 'Error: Fancybox Pop-Up Settings can not save.', 'cup_cp' ),
				'reset_message'		=> __( 'Fancybox Pop-Up Settings successfully reseted.', 'cup_cp' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Fancybox Pop-Up', 'cup_cp' ),
			'callback_function'	=> 'people_contact_email_inquiry_fancybox_popup_settings_form',
		);
...
global $people_contact_email_inquiry_fancybox_popup_settings;
$people_contact_email_inquiry_fancybox_popup_settings = new People_Email_Inquiry_Fancybox_Popup_Settings();

/** 
 * people_email_inquiry_fancybox_popup_settings_form()
 * Define the callback function to show subtab content
 */
function people_contact_email_inquiry_fancybox_popup_settings_form() {
	global $people_contact_email_inquiry_fancybox_popup_settings;
	$people_contact_email_inquiry_fancybox_popup_settings->settings_form();
}

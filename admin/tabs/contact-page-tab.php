...
{	
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/contact-page-contact-forms-settings.php' );
		include_once( $this->admin_plugin_dir() . '/settings/contact-page-popup-style-settings.php' );

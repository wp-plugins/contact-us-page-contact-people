...
<?php
/*-----------------------------------------------------------------------------------
People Email Inquiry 3RD Contact Form Tab
...
class People_Email_Inquiry_3RD_Contact_Form_Tab extends People_Contact_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'people_email_inquiry_3rd_contact_form_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/email-inquiry/email-inquiry-3rd-contact-form-settings.php' );
...
global $people_email_inquiry_3rd_contact_form_tab;
$people_email_inquiry_3rd_contact_form_tab = new People_Email_Inquiry_3RD_Contact_Form_Tab();

/** 
 * people_email_inquiry_3rd_contact_form_tab_manager()
 * Define the callback function to show tab content
 */
function people_email_inquiry_3rd_contact_form_tab_manager() {
	global $people_email_inquiry_3rd_contact_form_tab;
	$people_email_inquiry_3rd_contact_form_tab->tab_manager();
}

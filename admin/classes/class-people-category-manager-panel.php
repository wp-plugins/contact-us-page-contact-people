...
class People_Category_Manager_Panel
{
	public static function get_ultimate_version_name( $pro_version_name ) {
		return __( 'Ultimate Version', 'cup_cp' );
	}

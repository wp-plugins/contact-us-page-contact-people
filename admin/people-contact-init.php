...
function people_contact_install(){
	update_option('a3rev_wp_people_contact_lite_version', '1.1.4.2');
	update_option('a3rev_wp_people_contact_version', '1.1.4.2');
	update_option('a3rev_wp_people_contact_ultimate_version', '1.0.5.2');
...
add_filter( 'plugin_row_meta', array('People_Contact_Hook_Filter', 'plugin_extra_links'), 10, 2 );
	...
	add_action( 'wp_footer', array( 'People_Contact_Hook_Filter', 'frontend_footer_scripts' ) );

...
function people_contact_install(){
	update_option('a3rev_wp_people_contact_lite_version', '2.0.2');
	update_option('a3rev_wp_people_contact_version', '2.0.2');
	update_option('a3rev_wp_people_contact_ultimate_version', '2.0.2');

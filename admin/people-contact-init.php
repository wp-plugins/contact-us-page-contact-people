...
function people_contact_install(){
	update_option('a3rev_wp_people_contact_lite_version', '1.1.4.3');
	update_option('a3rev_wp_people_contact_version', '1.1.4.3');
	update_option('a3rev_wp_people_contact_ultimate_version', '1.0.5.3');

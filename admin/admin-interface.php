...
class People_Contact_Admin_Interface extends People_Contact_Admin_UI
{
	...
	public function admin_forms( $options, $form_key, $option_name = '', $form_messages = array() ) {
		global $people_contact_fonts_face, $people_contact_uploader, $current_subtab;
			...
			switch( $value['type'] ) {
                           ...
                           <!-- Border Corner : Rounded or Square -->
							...
							<!-- Border Rounded Value -->
                            	<div class="a3rev-ui-border-corner-value-container">
                                    <span class="a3rev-ui-border_corner-span"><?php _e( 'Rounded Value', 'cup_cp' ); ?></span>                            
				...
				case 'upload':
					...
					?><tr valign="top">
						...
						<td class="forminp forminp-<?php echo sanitize_title( $value['type'] ) ?>">
                        	<?php echo $description; ?>
                        	<?php echo $people_contact_uploader->upload_input( $name_attribute, $id_attribute, $option_value, $value['default'], esc_html( $value['name'] ), $class, esc_attr( $value['css'] ) , '' );?>
						</td>
					</tr><?php
		...
		<?php do_action( $this->plugin_name . '-' . trim( $form_key ) . '_settings_end' ); ?>
            <p class="submit">
                    <input type="submit" value="<?php _e('Save changes', 'cup_cp'); ?>" class="button-primary" name="bt_save_settings" />
...
$people_contact_admin_interface = new People_Contact_Admin_Interface();
